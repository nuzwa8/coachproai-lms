...
class NUZ_Ajax {
    ...
    public static function get_recent_activity() {
        ...
        $activities = $wpdb->get_results($wpdb->prepare(
            "SELECT 'student' as type, s.name, s.created_at, 'New student registered' as activity
             FROM {$wpdb->prefix}nuz_students s
             UNION ALL
             SELECT 'payment' as type, st.name, p.created_at, CONCAT('$', p.amount, ' payment received') as activity
